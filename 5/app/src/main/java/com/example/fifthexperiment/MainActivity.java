package com.example.fifthexperiment;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("ex 05");
    ...
    private void simpleNotification() {
        ...
        new NotificationCompat.MessagingStyle(jd)
                .addMessage("Hello how are you ?", new Date().getTime(), jd) .setBuilder(builder);
    ...
    private void notificationWithIcon() {
        ...
        new NotificationCompat.MessagingStyle(anupam)
                .addMessage("Microsoft Corporation in 1975", new Date().getTime(), anupam)
                .setBuilder(builder);
        notificationManager.notify(2, builder.build());
    }
    private void notificationWithImage() {
        Person bot = new Person.Builder()
                .setName("ELON MUSK") .setImportant(true)
                .setBot(true) .build();
        ...
        NotificationCompat.MessagingStyle.Message message = new
                NotificationCompat.MessagingStyle.Message("LAUNCHED NEW TESLA CAR", new Date().getTime(), bot);
    ...
    private void notificationWithGroupConvo()
    {
        ...
        new NotificationCompat.MessagingStyle(bot)
                ...
                .addMessage(message)
                .addMessage("Does this car look good?", new Date().getTime(), bot)
